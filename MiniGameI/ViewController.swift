...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var CCV1: CircleCodeView!
    @IBOutlet weak var CCV2: CircleCodeView!
    @IBOutlet weak var CCV3: CircleCodeView!
    @IBOutlet weak var CCV4: CircleCodeView!
    @IBOutlet weak var CCV5: CircleCodeView!
    @IBOutlet weak var CCV6: CircleCodeView!
    @IBOutlet weak var CCV7: CircleCodeView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        CCV1.backgroundColor = .blue
        CCV2.backgroundColor = .blue
        CCV3.backgroundColor = .blue
        CCV4.backgroundColor = .blue
        CCV5.backgroundColor = .blue
        CCV6.backgroundColor = .blue
        CCV7.backgroundColor = .blue
